...
{
	if (m_point_num) {
		SAFE_DELETE_ARRAY(m_point_list);
	}

	if (m_point_color_num) {
		SAFE_DELETE_ARRAY(m_point_color_list);
	}

	if (m_face_num) {
		SAFE_DELETE_ARRAY(m_face_list);
		SAFE_DELETE_ARRAY(m_face_normal_list);
	}

	if (m_physique_num) {
		SAFE_DELETE_ARRAY(m_physique);
	}
}
