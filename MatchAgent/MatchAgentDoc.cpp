...
BOOL CMatchAgentDoc::OnNewDocument()
{
	...
	m_pMatchAgent->SetIPString(MAgentConfig::GetInstance()->GetIP());
	m_pMatchAgent->SetTCPPort(MAgentConfig::GetInstance()->GetTCPPort());
	m_pMatchAgent->SetUDPPort(MAgentConfig::GetInstance()->GetUDPPort());
	m_pMatchAgent->SetMatchServerIP(MAgentConfig::GetInstance()->GetMatchServerIP());
	m_pMatchAgent->SetMatchServerTCPPort(MAgentConfig::GetInstance()->GetMatchServerTCPPort());
	MAgentConfig::ReleaseInstance();
...
void CMatchAgentDoc::DoTest()
{
	m_pMatchAgent->DisconnectFromMatchServer();
}